    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/services/add'); ?>" method="post">

                
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('service_name'); ?></label>
                        <div class="col-sm-9 col-lg-6 controls">
                            <input type="text" name="service_name" value="<?php echo set_value('service_name'); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-6 controls">
                            ...
                            <input type="text" name="opening_hours" value="<?php echo set_value('opening_hours'); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-6 controls">
                            ...
                            <input type="text" name="services_cost" value="<?php echo set_value('services_cost'); ?>"
