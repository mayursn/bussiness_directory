   ...
   google.maps.event.addDomListener(window, 'load', initialize);
      ...
      <div class="page-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-file-o"></i> <?php echo lang_key('dashboard');?> <div class="version">Searchnative business directory - version : <?php echo $config[0]->version;?></div></h1>
              ...
              <div class="col-md-12">
                ...
                <div class="tile">
                  ...
                  <p class="title">
                    ...
                    Searchnative Business Directory - Listing your local businesses
              ...
              <div class="col-md-12 tile-active">
                ...
                <div class="tile tile-blue">
                  ...
                  <p class="title">
                    ...
                    Searchnative Business Directory Admin

                  </p>

                  <p>

                      Searchnative Business Directory is the most complete and easy manageable Business Directory script
