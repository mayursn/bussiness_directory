...
<head>
    ...
    <title>Searchnative | Admin Panel</title>
...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your Searchnative with webhelios</h4>
          <p>You need to register you copy of Searchnative first with webhelios.</p>
          <div class="row" style="text-align:center">
              ...
              <form action="<?php echo site_url('admin/purchase/addkey');?>" method="POST" class="form-horaizontal">
                <label>Searchnative setup url : </label>
