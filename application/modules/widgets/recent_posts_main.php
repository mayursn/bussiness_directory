...
<span class="recent-posts" style="display:none;">
</span>
<div style="display:none;" class="ajax-loading recent-loading"><img src="<?php echo theme_url();?>/assets/img/loading.gif" alt="loading..."></div>
<a style="display:none;" href="" class="load-more-recent btn btn-blue" style="width:100%"><?php echo lang_key('load_more_recent_posts');?></a>
