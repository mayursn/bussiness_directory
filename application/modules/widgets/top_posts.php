    ...
    <div class="widget-content hot-properties">
        ...
        <ul class="list-unstyled">
            ...
            <li class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                <!-- Image <?php echo post_detail_url($post);?> -->
                <a href="#"><img class="img-responsive img-thumbnail" src="<?php echo get_featured_photo_by_id($post->featured_img);?>" alt="<?php echo get_post_data_by_lang($post,'title');?>" /></a>
                <!-- Heading <?php echo post_detail_url($post);?> -->
                <h4><a href="#"><?php echo get_post_data_by_lang($post,'title');?></a></h4>
